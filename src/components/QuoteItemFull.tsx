...
export default function QuoteItemFull({ user, quote }: QuoteItemFullProps) {
  ...
  const handleVote = (type: "up" | "down") => {
    ...
    // For example, send a request to update the upVotes or downVotes array in the backend
    if (type === "up") {
      console.log("Upvoted");
    } else {
  ...
  const handleDeleteQuote = () => {
    // Implement delete quote functionality here
  ...
  return (
    <div className="p-6 bg-[#D3EEFF] dark:bg-[#003759] text-[#003759] dark:text-[#D3EEFF] rounded-lg shadow-lg border-2 border-solid border-[#003759]">
      ...
      {/* Delete Quote Button */}
      {user && userEmailSplit === quote.userEmail && (
        <button
      ...
      <div className="mt-6">
        ...
        <div className="mt-4 flex flex-col">
          ...
          ></textarea>
          <button
            className="self-end px-4 py-2 bg-blue-500 text-white rounded-lg"
